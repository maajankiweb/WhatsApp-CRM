...
// Local mock translations for plain English
const t = (key: string): string => {
  const dict: Record<string, string> = {
    updateError: "Failed to update AI state",
    tookOver: "Conversation assigned to you; AI paused",
    resumed: "AI auto-reply resumed",
    networkError: "Network error; please try again",
    pausedTitle: "AI auto-reply paused",
    resume: "Resume AI",
    activeText: "AI is replying automatically to this conversation",
    takeOver: "Take over",
  };
  return dict[key] ?? key;
};
