...
```bash
# 1. Fork on GitHub: https://github.com/maajankiweb/WhatsApp-CRM → Fork
# 2. Clone your fork
...
```bash
git remote add upstream https://github.com/maajankiweb/WhatsApp-CRM.git  # once
git fetch upstream
git checkout main
...
[bug report](https://github.com/maajankiweb/WhatsApp-CRM/issues/new?template=bug_report.yml)
