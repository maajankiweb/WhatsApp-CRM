...
- [GitHub Security Advisories](https://github.com/AshishKmj/MY-WhatsApp-CRM-MJ/security/advisories/new)
...
In scope:
- Anything in this repository (`AshishKmj/MY-WhatsApp-CRM-MJ`), including webhook and auth
